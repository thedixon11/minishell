...
**
**     $CA    → unquoted   → expand env var CA + subject to word splitting
**     "$PI"  → double-quoted → expand env var PI, protected from word splitting
**     $BARA  → unquoted   → expand env var BARA + subject to word splitting
**
