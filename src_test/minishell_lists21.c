...
**
**   export AA=salut AA AB=capibara AB=
**
**   "export AA=salut AA AB=capibara AB=" → T_COMMAND (builtin + args, one node)
**
...
**                             AA stays "salut"
**     AB=capibara → set AB to "capibara" and export it
...
t_line	*build_line_list(void)
{
	...
	head = NULL;
	head = append_line(head, new_line_node(T_COMMAND, "export AA=salut AA AB=capibara AB=", 0));
	return (head);
}
...
int	main(int argc, char **argv, char **envp)
{
	...
	/* ── command list ───────────────────────────────────────────────────── */
	printf("\n=== COMMAND LIST : export AA=salut AA AB=capibara AB= ===\n\n");
