...
**
**   cd /home/jvasconc/Documents
**
**   "cd /home/jvasconc/Documents" → T_COMMAND (builtin + arg, one node)
**
**   All cmd_nb 0 — single command, no pipes, no redirections.
**
**   Absolute path — no tilde, no variable expansion needed.
**   Your cd builtin calls directly:
**     chdir("/home/jvasconc/Documents")
**   then updates OLDPWD and PWD in t_env accordingly.
**
**   If the path doesn't exist or is not a directory → print error,
**   exit code 1:
**     bash: cd: /home/jvasconc/Documents: No such file or directory
*/
t_line	*build_line_list(void)
{
	...
	head = NULL;
	head = append_line(head, new_line_node(T_COMMAND, "cd /home/jvasconc/Documents", 0));
	return (head);
}
...
int	main(int argc, char **argv, char **envp)
{
	...
	/* ── command list ───────────────────────────────────────────────────── */
	printf("\n=== COMMAND LIST : cd /home/jvasconc/Documents ===\n\n");
